//
//  indigolemonStopWatchViewController.h
//  TimeReminder2
//
...
@interface indigolemonStopWatchViewController : UIViewController<NSXMLParserDelegate, UIPickerViewDelegate, UIPickerViewDataSource,UIGestureRecognizerDelegate>
